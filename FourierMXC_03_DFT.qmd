...
it is a wave with a frequency of $0$, representing the average value of all the data points in the signal (global offsets). It is called the DC component, or
DC Offset, where DC stands for Direct Current.
